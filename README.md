...
#![error_molecules](https://latex.codecogs.com/gif.latex?e&space;=&space;n&space;\frac{\hat{x}}{\hat{y}}\\&space;\sigma_e&space;=&space;\sqrt{\left(\frac{\hat{x}}{\hat{y}}\sigma_n&space;\right&space;)^2&space;&plus;\left(n\frac{\hat{x}}{\hat{y}}\sigma_{\hat{x}}&space;\right&space;)^2&plus;\left(n\frac{\hat{x}}{\hat{y}^2&space;}\sigma_{\hat{y}}&space;\right&space;)^2&space;}
